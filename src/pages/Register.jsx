            ...
            <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <div className="hidden md:flex flex-col justify-center pl-6">
                    <div className="mb-6">
                        ...
                        <p className="mt-3 text-lg text-gray-700">Create your account to complete invitation onboarding by role.</p>
                    </div>
                ...
                <div className="flex items-center justify-center">
                    <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
                        <div className="mb-6 text-center">
                            ...
                            <p className="text-sm text-gray-500 mt-2">Register to continue with your onboarding flow.</p>
                        </div>
