        ...
        <Card className="border-none shadow-2xl ring-1 ring-slate-100 rounded-3xl overflow-hidden">
          ...
          <CardContent className="p-8 space-y-6">
            ...
            {data.role === 'manager' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <Label htmlFor="department" className="text-sm font-bold text-slate-700 uppercase tracking-wider">Department</Label>
                  <Input id="department"  {...register('department')} className="h-12 rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 font-medium transition-all" />
                </div>
                <div className="space-y-2">
